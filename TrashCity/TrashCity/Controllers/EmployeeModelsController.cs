...
namespace TrashCity.Controllers
{
    public class EmployeeModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeId,EmployeeFirstName,EmployeeLastName,EmployeeAddress,EmployeeZipCode")] EmployeeModel employeeModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeId,EmployeeFirstName,EmployeeLastName,EmployeeAddress,EmployeeZipCode")] EmployeeModel employeeModel)
        {
            if (ModelState.IsValid)
            {
